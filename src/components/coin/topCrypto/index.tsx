        ...
        <table className="w-full border-collapse text-left text-sm">
          <thead className="border-b">
            <tr>
              <th className="py-2 px-4 font-medium">Exchange</th>
              <th className="py-2 px-4 font-medium">Pair</th>
              <th className="py-2 px-4 font-medium hidden sm:table-cell">
                Last Price
              </th>
              <th className="py-2 px-4 font-medium">Volume</th>
            </tr>
          ...
          <tbody>
            {overview
              ? marketType?.slice(0, 10).map((item: any, index: number) => (
                  <tr
                    key={index}
                    className="hover:bg-gray-100 dark:hover:bg-gray-700 h-[80px] border-b"
                  >
                    <td className="py-2 px-4 ">
                    ...
                    <td className="py-2 px-4 ">
                      <Link href={`/price/${item.symbol}`}>
                        <span className="text-blue-500">{item?.market_pair}</span>
                      </Link>
                    </td>
